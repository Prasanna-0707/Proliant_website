...
/*
* Notify Dashboard whenever an enquiry changes.
*/
const notifyEnquiriesUpdated = () => {
  window.dispatchEvent(
    new Event("enquiriesUpdated")
  );
...
function Enquiries() {
  ...
  /*
   * Unread count used on Enquiries page.
   */
  ...
  const handleToggleStatus =
    async (enquiry) => {
      ...
      try {
        ...
        /*
         * IMPORTANT:
         * Tell Dashboard that unread count changed.
         */
  ...
  const handleViewEnquiry =
    async (enquiry) => {
      ...
      try {
        ...
        /*
         * IMPORTANT:
         * Viewing an unread enquiry changes it to Read,
         * so Dashboard count must update.
         */
        notifyEnquiriesUpdated();
      } catch (error) {
        console.error(
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * If the deleted enquiry was unread,
       * Dashboard unread count must decrease.
       */
      notifyEnquiriesUpdated();
